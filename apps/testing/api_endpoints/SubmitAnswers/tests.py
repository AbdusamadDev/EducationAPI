...
from apps.testing.models import Answer, Category, Question, Quiz, TestResult
...
class QuizTest(APITestCase):
    def setUp(self):
        ...
        self.answer1_1_correct = Answer.objects.create(
            question=self.question1, answer_text="Answer 1-1", is_correct=True
        )
        self.answer1_2 = Answer.objects.create(question=self.question1, answer_text="Answer 1-2")
        self.answer2_1_correct = Answer.objects.create(
            question=self.question2, answer_text="Answer 2-1", is_correct=True
        )
